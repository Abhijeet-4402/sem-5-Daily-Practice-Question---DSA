// Last updated: 17/3/2026, 10:43:22 am
1class Solution {
...
15				int minHealth = Integer.MAX_VALUE;
16				if(i+1<n) {
17					minHealth = Math.min(minHealth, dp[i+1][j]);
18				}
19				if(j+1<m) {
20					minHealth = Math.min(minHealth, dp[i][j+1]);
21				}
22				dp[i][j] = Math.max(1, minHealth - arr[i][j]);
23			}
24		}
25
26		return dp[0][0];
